...
### ID 10 O documento inclui um tópico sobre as tarefas designadas aos participantes durante a avaliação?

O documento não inclui um tópico sobre as tarefas designadas aos participantes durante a avaliação.

### ID 11 Existe um tópico dedicado à lista dos problemas de usabilidade ainda não corrigidos?

O documento não inclui um tópico dedicado à lista dos problemas de usabilidade ainda não corrigidos.
