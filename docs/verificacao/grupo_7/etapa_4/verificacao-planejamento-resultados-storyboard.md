...
Link e frame do vídeo não listado no youtube da pessoa que fez o artefato ([Ester Lino](https://github.com/esteerlino)) mostrando as alterações que ela realizou a partir dos problemas encontrados e sugestões de melhorias apontados pelo avaliador principal [Kallyne Macedo](https://github.com/kalipassos).
